...
## [0.23.4](https://github.com/adfernandes/atsamd/compare/atsamd-hal-0.23.3...atsamd-hal-0.23.4) - 2026-05-13

### Fixed

- *(rtc)* disable compare interrupt instead of stopping the RTC counter ([#992](https://github.com/adfernandes/atsamd/pull/992))

### Other

- Fix nightly clippy lint ([#1006](https://github.com/adfernandes/atsamd/pull/1006))
- Update DMAC documentation ([#1005](https://github.com/adfernandes/atsamd/pull/1005))
- Make ADC `check_read_discard` private again ([#1003](https://github.com/adfernandes/atsamd/pull/1003))
