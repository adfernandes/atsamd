...
## [0.21.1](https://github.com/adfernandes/atsamd/compare/atsamd-hal-0.21.0...atsamd-hal-0.21.1) - 2025-04-04

### Added

- *(tc)* Add support for TC6/7 on applicable chips ([#835](https://github.com/adfernandes/atsamd/pull/835))
- Add ehal 1.0 InputPin impl for ExtInt ([#826](https://github.com/adfernandes/atsamd/pull/826))
